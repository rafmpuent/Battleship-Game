...
bool inicioJuego = false; //Bandera para saber si el pulsador que inicia el juego ha sido presionado
...
void checkSerial() {
  while(Serial2.available()){ //Comunicacion entre esps32
    ...
    if(response.equals("s")) { //Se ha presionado el boton de Start
      madeInHeaven(); //Se inicializan los datos
    }
